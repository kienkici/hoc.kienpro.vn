    ...
    <div className="min-h-[75vh] flex flex-col items-center justify-center p-6 text-center space-y-6 max-w-xl mx-auto">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-zinc-300 leading-relaxed">
          Hệ thống KIENPRO LMS đã ghi nhận giao dịch chuyển khoản. Đơn hàng <strong className="text-gold-400">KP98241</strong> đã được xử lý tự động.
        </p>
      </div>
      ...
      <div className="p-4 rounded-xl border border-zinc-800 bg-zinc-900/60 text-left text-xs space-y-3 w-full">
        ...
        <p className="text-zinc-400 leading-relaxed">
          Chúng tôi đã gửi một Email chứa liên kết kích hoạt đến địa chỉ <strong className="text-white">hocvien.kienpro@gmail.com</strong>. Vui lòng mở Email và bấm nút đặt mật khẩu lần đầu để vào học ngay.
        </p>
      </div>

      <div className="flex flex-col sm:flex-row gap-3 pt-2 w-full">
        <Button variant="gold" size="lg" asChild className="w-full">
          <Link href="/activate?token=demo-token-12345">
            Đi Tới Trang Kích Hoạt Demo <ArrowRight className="w-4 h-4 ml-2" />
          </Link>
        </Button>
      </div>
    </div>
